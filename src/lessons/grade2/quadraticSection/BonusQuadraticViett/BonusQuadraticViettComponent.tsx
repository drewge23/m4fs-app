...
export const generateBonusQuadraticViett = () => {
    const MAXQUAD = 21;
    let quadArr = [];
    ...
    return {
        ...
        rightAnswers: [a, b, c, x1, x2].map(i => i.toString())
    }
}
//&#178;
const BonusQuadraticViettComponent = ({formik, coefs}: any) => {
    return (
        <div>
        ...
        <label htmlFor="answers[3]"><span> {'x'}<sub>1</sub>{' = '} </span></label>
            <input
                id="answers[3]"
                name="answers[3]"
                type="text"
        ...
        <label htmlFor="answers[4]"><span> {'x'}<sub>2</sub>{' = '} </span></label>
            <input
                id="answers[4]"
                name="answers[4]"
                type="text"
...
export default BonusQuadraticViettComponent;