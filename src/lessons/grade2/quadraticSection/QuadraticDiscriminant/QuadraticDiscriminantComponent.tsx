...
export const generateQuadraticDiscriminant = () => {
    const MAXQUAD = 21;
    let quadArr = [];
    ...
    return {
        ...
        rightAnswers: [a, b, c, D, sqrtD].map(i => i.toString())
    }
}
//&#178;
const QuadraticDiscriminantComponent = ({formik, coefs}: any) => {
    return (
        <div>
...
export default QuadraticDiscriminantComponent;